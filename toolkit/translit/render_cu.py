...
pairs = [
    ...
    (r"-",      "-"), # дефис
    #  <?>            # вопросительный знак обычного вида
    ...
    #  "              # два штриха \\ над буквой (особ. над ижицей), не обозначающие выносного И или Й
    (r"~",      "7"), # простое титло
    ...
    # в ограниченном контексте: \т только в составе буквы w\т
